...
const SubjectListPage = () => {
  ...
  const renderRow = (subject: Subject) => (
    <tr key={subject._id} className="text-left text-gray-500 text-md even:bg-slate-50 hover:bg-purple-100">
  ...
  return (
    <div className="bg-white rounded-md flex-1 m-4 mt-0 p-1 sm:p-2 md:p-3 lg:p-4">
      ...
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-xl sm:text-md md:text-lg lg:text-xl 2xl:text-xl font-semibold">All Subjects</h1>
